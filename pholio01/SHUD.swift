...
class SHUD {
    ...
    private var size: CGSize {
        ...
        case .horizontal:
            return CGSize(width: NewConstants.horizontalHUDWidth, height: NewConstants.horizontalHUDHeight)
        case .vertical:
            return CGSize(width: NewConstants.verticalHUDWidth, height: NewConstants.verticalHUDHeight)
        }
    }
    ...
    fileprivate func configureHUDView() {
        ...
        hudView.layer.cornerRadius = NewConstants.cornerRadius
    ...
    fileprivate func configureSubviews() {
        ...
        label.font = .systemFont(ofSize: NewConstants.labelFont)
        label.translatesAutoresizingMaskIntoConstraints = false
        
        stackView.distribution = .fill
        stackView.alignment = .center
        stackView.spacing = NewConstants.stackViewSpacing
